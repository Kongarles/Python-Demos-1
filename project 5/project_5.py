...
last_year = pd.read_csv(r"C:\Users\Kayra\Masaüstü\Python_Demos\Demos\project 5\employee_revenue_lastyear.csv")
...
all_data.fillna(value=all_data.mean(numeric_only=True), inplace=True)
